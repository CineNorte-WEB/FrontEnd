...
const RestaurantOverlay = ({ restaurant, onClose }) => {
  ...
  return (
    <div className="absolute z-50 bg-white rounded-lg shadow-lg right-4 top-20 w-96 font-yeonsung">
      <div className="relative p-6">
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              <span className="mr-2 text-gray-600">{restaurant.category}</span>
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-lg bg-gray-50">
            ...
            <p>
              <span className="font-bold">⏰ 영업시간:</span> {restaurant.hours}
            </p>
          </div>
