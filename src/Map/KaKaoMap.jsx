...
function KakaoMap() {
  ...
  const transformPlaceData = (place) => {
    ...
    const manualCoordinates = {
      ...
      이모네왕파전: { lat: 37.67378058202286, lng: 127.03857397066574 },
      은하곱창: { lat: 37.67378058202286, lng: 127.03857397066574 },
      신락원: { lat: 37.579109331781005, lng: 127.05567626450954 },
      브레드칸청량리점: { lat: 37.67378058202286, lng: 127.03857397066574 },
