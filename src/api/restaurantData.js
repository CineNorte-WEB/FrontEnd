...
export const restaurantData = [
  ...
  },
  {
    ...
    reviewCount: 1,
    rating: 5,
    // likePoints를 문자열로 저장 (이전 코드와 동일한 형식)
    likePoints:
      "[{'category': '맛', 'score': '4'}, {'category': '가성비', 'score': '3'}, {'category': '친절', 'score': '2'}]",
    imageUrl:
      "https://camchelin-bucket.s3.ap-northeast-2.amazonaws.com/Images/%EC%99%B8%EB%8C%80/%EC%84%B1%ED%99%94%EA%B8%88%ED%83%95%EB%A7%88%EB%9D%BC%ED%83%95%26%ED%8A%80%EA%B9%80%EA%BA%BC%EC%B9%98_img.png",
    univName: "한국외국어대학교",
    menus: [
      {
        id: 379,
